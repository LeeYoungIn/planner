...
/*	static public boolean needToloadAD = false;
  ...
  static public void getEventListFromServer(final DataLoadCallback callback){
	    ServerConnector.getRecentData(mPrefs.getLong("LASTMODEVENT", 0), ServerConnector.EVENT, new ServerConnector.QueryCallBack(){
			...
			@Override
			public void success(String email, String point) {
				// TODO Auto-generated method stub
...
//		StackMob stackmob = StackMobCommon.getStackMobInstance();
		...
		ServerConnector.getRecentData( mPrefs.getLong("LASTMODSHOP", 0) , ServerConnector.SHOP, new ServerConnector.QueryCallBack() {
